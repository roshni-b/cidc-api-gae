...
def upgrade():
    ...
    op.drop_constraint('hande_records_trial_id_assay_id_fkey', 'hande_records', type_='foreignkey')
...
def downgrade():
    ...
    op.create_foreign_key('hande_records_trial_id_assay_id_fkey', 'hande_records', 'uploads', ['trial_id', 'assay_id'], ['trial_id', 'id'])
