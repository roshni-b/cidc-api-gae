...
def upgrade():
    ...
    op.create_table('manifest_uploads',
    ...
    sa.Column('manifest_patch', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.ForeignKeyConstraint(['uploader_email'], ['users.email'], onupdate='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_manifest_uploads_trial_id'), 'manifest_uploads', ['trial_id'], unique=False)
