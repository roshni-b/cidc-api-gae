...
def upgrade():
    ...
    sa.Column('status', sa.Enum('started', 'upload-completed', 'upload-failed', 'merge-completed', 'merge-failed', name='upload_status_enum'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['image_url'], ['hande_images.object_url'], ),
    ...
    op.create_unique_constraint(None, 'shipments', ['trial_id', 'manifest_id'])
