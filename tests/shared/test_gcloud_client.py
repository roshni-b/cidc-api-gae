...
def test_grant_download_access(monkeypatch):
    ...
    def set_iam_policy(policy):
        ...
        assert condition["title"] == f"Download access on 10021/wes* for {EMAIL}"
        assert "generated by the CIDC API" in condition["description"]
    ...
    matching_binding = {
        "condition": {
            "title": "Download access on 10021/wes* for test@email.com",
            "description": "Auto-generated by the CIDC API on 2020-08-27 22:39:46.946004",
            "expression": 'resource.name.startsWith("projects/_/buckets/cidc-data-staging/objects/10021/wes") && request.time < timestamp("2020-10-26T00:00:00Z")',
        },
...
def test_revoke_download_access(monkeypatch):
    bindings = [
        ...
        {
            "condition": {
                "title": "Download access on 10021/cytof* for test@email.com",
                "description": "Auto-generated by the CIDC API on 2020-08-27 22:39:46.946004",
                "expression": 'resource.name.startsWith("projects/_/buckets/cidc-data-staging/objects/10021/cytof") && request.time < timestamp("2020-10-26T00:00:00Z")',
            },
            "members": {"user:test@email.com"},
            "role": GOOGLE_DOWNLOAD_ROLE,
        },
    ...
    _mock_gcloud_storage(bindings[:1] + bindings, set_iam_policy, monkeypatch)
    revoke_download_access(EMAIL, "10021", "wes")
