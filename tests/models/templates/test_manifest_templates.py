    ...
    with cidc_api.app_context():
        ...
        def check_insert(session):
            ...
            participants = (
                ...
                .order_by(Participant.cimac_participant_id)
                .all()
            )
            ...
            for i, sample in enumerate(samples):
                ...
                assert (
                    sample.processed_sample_concentration == 0.3 if i in (1, 5) else 0.2
                )
    ...
    with cidc_api.app_context():
        ...
        def check_insert(session):
            ...
            for i, sample in enumerate(samples):
                ...
                assert sample.processed_sample_quantity in (
                    (4, 4.0) if i < 2 else (1, 1.0)
                )
